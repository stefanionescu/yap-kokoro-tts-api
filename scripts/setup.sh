...
LANG_CODE=a
KOKORO_SPEED=1.0
KOKORO_SPLIT_PATTERN='(?<=[.?!])\s+'
STREAM_CHUNK_SECONDS=0.04
...
QUEUE_MAXSIZE=128
SCHED_QUANTUM_BYTES=16384
PRIORITY_QUANTUM_BYTES=2048
QUEUE_WAIT_SLA_MS=1000
MAX_QUEUED_REQUESTS=4

# WebSocket send controls (balanced for low overhead + fast TTFB)
WS_FIRST_CHUNK_IMMEDIATE=1
WS_BUFFER_BYTES=16384
WS_FLUSH_EVERY=16
WS_SEND_TIMEOUT=3.0
WS_LONG_SEND_LOG_MS=250
WS_MAX_LATENCY_MS=50
EOL
